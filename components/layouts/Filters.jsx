          ...
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Laptops/PC"
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Laptops/PC")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Laptops/PC </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
          ...
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Tablets/HP"
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Tablets/HP")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Tablets/HP </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Beauties"
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Beauties")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Beauties </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
